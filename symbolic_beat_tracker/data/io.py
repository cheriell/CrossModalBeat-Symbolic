...
def read_note_sequence(midi_file, start_time=0., end_time=None):
    ...
    Returns
    -------
    note_seq: (numpy.array) in the shape of (n, 4), where n is the number of notes, and 4 is the number of features including (pitch, onset, duration, velocity). The note sequence is sorted by onset time.
    """
